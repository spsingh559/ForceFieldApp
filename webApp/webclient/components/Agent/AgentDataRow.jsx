...
//   import TradeSubChildComponent from './TradeSubChildComponent.jsx';
  class AgentDataRow extends React.Component{
    state={
        ...
        actualLaycanLoadedFrom:new Date(this.props.data.laycan_loadport.split("-")[0]),
        actualLaycanLoadedTo:new Date(this.props.data.laycan_loadport.split("-")[1]),
        actualCargoLoadedFrom:new Date(this.props.data.cargo_loading_date.split("-")[0]),
        actualCargoLoadedTo:new Date(this.props.data.cargo_loading_date.split("-")[1]),
        actualVesselLoadedFrom:new Date(this.props.data.vessel_move_loadport.split("-")[0]),
        actualVesselLoadedTo:new Date(this.props.data.vessel_move_loadport.split("-")[1]),
