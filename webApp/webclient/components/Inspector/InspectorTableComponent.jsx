...
import InspectorDataRow from './InspectorDataRow';
...
class InspectorTableComponent extends Component {
                ...
                <TableBody>
                        {
                            this.props.data.map((item, i) => {
                                return (                                    
                                    <InspectorDataRow handleChangeAgentSubmit={this.handleChangeAgentSubmit} data={item} key={i} />
                                );
                            })
                        }           
                   </TableBody>
...
export default InspectorTableComponent;