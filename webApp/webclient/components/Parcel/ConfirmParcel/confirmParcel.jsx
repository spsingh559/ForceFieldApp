...
import ParcelTableComponent from "../PendingParcel/ParcelTableComponent"
...
export default class confirmPacel extends React.Component{
    ...
    render(){
        ...
        <Col md={12} style={{paddingLeft:"0", paddingRight:"0"}}>
          ...
          <ParcelTableComponent headingText="Confirmed Parcel" number={this.state.pareclCount}
         pendingParcelData={this.state.parcelData}/>
