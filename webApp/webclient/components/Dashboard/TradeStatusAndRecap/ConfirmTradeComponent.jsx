...
export default class ConfirmTradeComponent extends React.Component {
  ...
  render() {
      return (
           ...
           <div style={style.paperStyle} zDepth={2} onClick={this.navigateCT}>
           <div style={{marginLeft:"20px"}}>
        <span style={style.labelStyle}>Confirmed Trade</span>
        <br />
        <br />
        <span style={style.labelStyleNumber} >{this.state.secondsElapsed} </span>
        ...
        <span style={style.sellRectange}  >
              ...
              <span style={style.sellText} > {this.state.secondsElapsedSell} Sell </span>
      </Col>
      <Col xs={4}>
      <span style={style.buyRectange}>
              </span>
              <span style={style.buyText}> {this.state.secondsElapsedBuy} Buy </span>  
      </Col>
