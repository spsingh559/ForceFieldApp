...
class TradeRecapFilterComponent extends Component{
    state = {
      ...
      buyCTData=()=>{
          this.props.buyCTData();
      }
    sellCTData=()=>{
        this.props.sellCTData();
    ...
    render() {
        return (
            <div>
                ...
                <li><button onClick={this.allCTData} className="selected"> ALL</button> </li>
                <li><button onClick={this.buyCTData}> BUY</button></li>
                <li><button onClick={this.sellCTData}> SELL</button></li>
                </ul>
                <form>
